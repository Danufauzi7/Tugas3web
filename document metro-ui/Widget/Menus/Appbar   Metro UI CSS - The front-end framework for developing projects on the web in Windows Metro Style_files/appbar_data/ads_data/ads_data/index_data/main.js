...
var shapeType = [0, 2, 4, 0, 2, 3, 1, 4, 0, 3, 0, 1, 0, 0, 3, 0, 2, 4, 4, 1, 2, 3, 0, 2, 0, 0, 1, 2, 0, 4, 3, 1, 1, 3, 2, 0, 0, 2];
var shapeDockUnitX = [-1, -1, -1, -1, 9, 5, 9, 9, 9, 9, 15, 11, 15, 19, 17, 21, 21, 19, 21, 21, 23, 25, 27, 27, 27, 31, 35, 39, 39, 37, 33, 37, 43, 41, 43, 47, 45, 49];
var shapeDockUnitY = [-1, -1, 1, 3, 5, 1, 5, -1, 1, 5, -1, 3, -1, -1, 1, 1, 5, 1, -1, 5, -1, 1, 3, 3, 3, 3, -1, 3, -1, -1, 5, 5, 3, 1, 7, -1, 5, -3];
var shapeRotation = [0, 0, 0, 0, 180, -90, 180, 0, 0, -90, 90, -90, 0, 90, -90, 90, 180, 0, 0, -90, 0, 0, 0, 0, -90, 180, 90, 180, 90, 0, -90, -90, 180, 0, -90, 90, -90, 90];
...
function pageLoaded() 
{
	...
	console.log("728x90 Phase 2 Ad version: " + adVersion);
	console.log("Reporting label: (" + dynamicContent.APAC_GDN_Q4_Tangram_Datasheet_ID_728x90_EN[0].Reporting_Label + ")");
	console.log("Exit url: (" + dynamicContent.APAC_GDN_Q4_Tangram_Datasheet_ID_728x90_EN[0].Exit_URL.Url + dynamicContent.APAC_GDN_Q4_Tangram_Datasheet_ID_728x90_EN[0].Sub_ID + ")");

    //Load in CSS
    var extCSS = document.createElement("link");
    extCSS.setAttribute("rel", "stylesheet");
    extCSS.setAttribute("type", "text/css");
    extCSS.setAttribute("href", dynamicContent.APAC_GDN_Q4_Tangram_Datasheet_ID_728x90_EN[0].CSS_Name);
    document.head.appendChild(extCSS);

    var script = document.createElement('script');
	script.type = 'text/javascript';
	script.src = dynamicContent.APAC_GDN_Q4_Tangram_Datasheet_ID_728x90_EN[0].JS_Name;
...
function initApp()
{
	...
	$("#buttonLabel").innerHTML = dynamicContent.APAC_GDN_Q4_Tangram_Datasheet_ID_728x90_EN[0].CTA_Text; // CTA_Text
...
{
	var tempString = "";
	bgEndColor = dynamicContent.APAC_GDN_Q4_Tangram_Datasheet_ID_728x90_EN[0].BG_Color; // BG_Color
	introCopy2Start = parseFloat(dynamicContent.APAC_GDN_Q4_Tangram_Datasheet_ID_728x90_EN[0].Start_Time_Text_2); // Start_Time_Text_2
	wipeStart = parseFloat(dynamicContent.APAC_GDN_Q4_Tangram_Datasheet_ID_728x90_EN[0].Start_Time_Wipe); // Start_Time_Wipe

	parseFontSizes()

	// Grab dynamic copy text & place into array holders
	tempString  = dynamicContent.APAC_GDN_Q4_Tangram_Datasheet_ID_728x90_EN[0].text_1; // Text_1_Line_1
	copyBatch1 = tempString.split("|");
	tempString  = dynamicContent.APAC_GDN_Q4_Tangram_Datasheet_ID_728x90_EN[0].text_2; // Text_1_Line_1
	copyBatch2 = tempString.split("|");
	tempString  = dynamicContent.APAC_GDN_Q4_Tangram_Datasheet_ID_728x90_EN[0].text_3; // Text_1_Line_1
...
function parseFontSizes()
{
	...
	if (dynamicContent.APAC_GDN_Q4_Tangram_Datasheet_ID_728x90_EN[0].fontsize && dynamicContent.APAC_GDN_Q4_Tangram_Datasheet_ID_728x90_EN[0].fontsize != "")
	{
		tempString = dynamicContent.APAC_GDN_Q4_Tangram_Datasheet_ID_728x90_EN[0].fontsize;
...
function initMainAnimations()
{
	...
	tl.to($("#ctaTriangleLeft"), dockCTADuration, {left:441, top:20, ease:Power1.easeInOut}, "dockCTA");
	tl.to($("#ctaParallelogram"), dockCTADuration, {left:442, top:20, ease:Power1.easeInOut}, "dockCTA");
	tl.to($("#ctaTriangleRight"), dockCTADuration, {left:540, top:19, ease:Power1.easeInOut}, "dockCTA");
...
{
	Enabler.exitOverride("CTA Exit", dynamicContent.APAC_GDN_Q4_Tangram_Datasheet_ID_728x90_EN[0].Exit_URL.Url + dynamicContent.APAC_GDN_Q4_Tangram_Datasheet_ID_728x90_EN[0].Sub_ID);
}
